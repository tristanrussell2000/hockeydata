...
e.`details.xCoord`, e.`details.yCoord`, e.`details.reason`, e.`details.blockingPlayerId`, e.`details.zoneCode`, e.typeCode, homeTeamDefendingSide, g.homeTeamId, g.visitingTeamId, season
FROM events AS e 
